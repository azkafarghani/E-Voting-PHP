...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<img src="dist/img/kotakipb.png" width=170px />
			<br>
			<a href="login.php">
...
if (isset($_POST['btnLogin'])) {  
	...
	if ($jumlah_login ==1 ){
		...
		echo "<script>
			Swal.fire({title: 'Login Berhasil',text: '',confirmButtonText: 'OK'
			}).then((result) => {if (result.value)
				{window.location = 'index.php';}
			})</script>";
		}else{
		echo "<script>
			Swal.fire({title: 'Login Gagal',text: '',confirmButtonText: 'OK'
			}).then((result) => {if (result.value)
